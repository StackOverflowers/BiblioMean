...
const Libray = require("../models/library");
...
const registerUser = async (req, res) => {
  ...
  let existingLibrary = await Libray.findOne({ _id : req.body.libraryId });
  if (!existingLibrary) return res.status(400).send("The library not exist");
